...
export const STANDARD_GATES: Record<string, Gate> = {
  ...
  X90: pulseGate("X90", "(\u03c0/2)_x", 0, Math.PI / 2, "R_x(\u03c0/2) pulse"),
  Y90: pulseGate("Y90", "(\u03c0/2)_y", 90, Math.PI / 2, "R_y(\u03c0/2) pulse"),
  X180: pulseGate("X180", "(\u03c0)_x", 0, Math.PI, "R_x(\u03c0) pulse"),
  Y180: pulseGate("Y180", "(\u03c0)_y", 90, Math.PI, "R_y(\u03c0) pulse"),
  P120_180: pulseGate("P120_180", "(\u03c0)_{120\u00b0}", 120, Math.PI, "R_{120\u00b0}(\u03c0) pulse"),
  XM180: pulseGate("XM180", "(\u03c0)_{-x}", 180, Math.PI, "R_{-x}(\u03c0) pulse"),
  YM180: pulseGate("YM180", "(\u03c0)_{-y}", 270, Math.PI, "R_{-y}(\u03c0) pulse"),
  XM360: pulseGate("XM360", "(2\u03c0)_{-x}", 180, 2 * Math.PI, "R_{-x}(2\u03c0) pulse"),
};
...
export const PUZZLES: Puzzle[] = [
  ...
  {
    id: "robust_two_pulse_90",
    title: "Two-pulse 90",
    targetState: targetFromStateSequence(STATE_ZERO, ["X90", "Y90"]),
    gateLimit: 2,
    solution: ["X90", "Y90"],
    allowedGates: ["X90", "Y90", "X180", "Y180"],
    gateSetLabel: "Composite sequence: (\u03c0/2)_x (\u03c0/2)_y",
    robust: true,
    defaultErrorEpsilon: 0.05,
    successThreshold: 0.998,
    mission: "Use a two-pulse 90-degree composite sequence under pulse-length error.",
  },
  {
